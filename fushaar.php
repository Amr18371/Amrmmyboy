...
bot('sendphoto',[
'chat_id'=>$chat_id,
'photo'=>"https://telegra.ph/file/dfeb8dac954f80f2aa5bc.jpg",
'caption'=>"
*اهلا بك $name في بوت افلام🎥 *
",'parse_mode'=>"Markdown",
 'reply_markup'=>json_encode([
      'inline_keyboard'=>[
...
$reply_markup['inline_keyboard'][] = [['text'=>"↩️رجوع",'callback_data'=>"movie"]];
bot("sendMediaGroup",[
"chat_id"=>$chat_id,
